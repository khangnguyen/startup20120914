<div class="span6" style="float: none; margin: 20px auto; border: 1px solid; padding: 10px; background: white;">
   <? if ($data->portfolioPhotos) { ?>
        <a href="http://startup.cogini.com/portfolio/view/id/<?=$data->id?>">
          <img src="<?=$data->portfolioPhotos[0]->image('portfolio_photo')?>" style="width:100%"/>
        </a>
   <? } ?>
