...
<div style="margin: 20px auto; text-align: center;">
    <img src="<?=$model->image('bg_photo')?>" style="height:952px"/>
</div>
...
<img src="/images/icon.png" style="position: absolute; top: 845px; left: 272px"/>
...
<script>
$('body').css('background-image', 'url(/images/layout_bg4.jpg)');
$('body').css('background-size', 'auto');
$('body').css('background-repeat', 'repeat-x');
$('body').css('height', '1420px');
</script>